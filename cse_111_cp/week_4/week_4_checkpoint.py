...
def main():
    ...
    # Get the radius and the height of the cone from the user.
    ...
    # for the radius and the height that came from the user.

    vol = cone_volume(radius, height)

    # Print the radius, height, and 
    # volume for the usser to see   
    print(f"Radius {radius:.2f}")
    print(f"Height {height:.2f}")
    print(f"Volume {vol:.1f}")

def cone_volume(radius, height):
    """Compute and return the volume of the right circular cone."""
