import random
manches = int(input("Combien de manches voulez vous jouez   ?"))
score_joueur = 0
score_ordi = 0
...
while score_joueur < manches and score_ordi < manches :
    ...
    while choix_joueur not in options : 
        input("Choix invalide! Choisissez pierre, papier ou ciseaux ")
    choix_ordi = random.choice(options)
    if choix_joueur == choix_ordi :
        print("Egalité. Relancez le jeux pour rejouer")
    ...
    or choix_joueur == "ciseaux" and choix_ordi == "papier":
        ...
        print("L'ordinateur remporte la manche", choix_ordi, "bat", choix_joueur)
        score_ordi += 1
