...
f=open("C:/Users/Lap Kipoy/AppData/Local/Programs/Python/Python311/python.exe" "e:/my_programmes/grade_11_etro_and_sc/Purchases.py")
#f=open("Purchases.py","r")
